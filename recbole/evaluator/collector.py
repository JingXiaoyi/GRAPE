...
class Collector(object):
    ...
    def jing_calcu_green(self, logger):
        ...
        logger.info(f'Jing Green Values @5: Len_test: {len_all}, '
              f'Env_score: {format(green_values[0][0]/len_all/5, ".4f")}, '
              f'Nutri_score: {format(green_values[0][1]/len_all/5, ".4f")}, '
              f'Env_score: {format(green_values[0][2]/len_all/5, ".4f")}, ')
        logger.info(f'Jing Green Values @10: Len_test: {len_all}, '
              f'Env_score: {format(green_values[1][0]/len_all/10, ".4f")}, '
              f'Nutri_score: {format(green_values[1][1]/len_all/10, ".4f")}, '
              f'Env_score: {format(green_values[1][2]/len_all/10, ".4f")}, ')
        logger.info(f'Jing Green Values @20: Len_test: {len_all}, '
              f'Env_score: {format(green_values[2][0]/len_all/20, ".4f")}, '
              f'Nutri_score: {format(green_values[2][1]/len_all/20, ".4f")}, '
              f'Env_score: {format(green_values[2][2]/len_all/20, ".4f")}, ')
        return
